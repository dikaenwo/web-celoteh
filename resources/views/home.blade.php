<x-layout>
          ...
          <div class="herobannerarea__content__wraper">
            <div class="herobannerarea__title">
              ...
              <div class="herobannerarea__title__heading__2">
                <h2>Jadi Pede Berbicara di Depan Banyak Orang</h2>
              </div>
            </div>

            <div class="herobannerarea__text">
              <p style="text-align: justify;">
                Celoteh Yuk adalah platform pembelajaran public 
                speaking dengan jam belajar fleksibel dan 
                dilengkapi dengan Teknologi AI Coaching yang 
                canggih
              </p>
            </div>
            <div class="hreobannerarea__button">
              <a class="herobannerarea__button__1" href="/#pricing">Lihat Paket Kelas</a>
            </div>
          </div>
        </div>
        <div
      ...
      <div class="row" data-aos="fade-up">
        <div class="brandarea__wraper brandarea__wraper__2">
          <div class="brandarea__img">
            <a href="#"
              ><img loading="lazy" src="img/brand/logotmj.png" width="100px" alt="brand"
            /></a>
          </div>
          <div class="brandarea__img">
            <a href="#"
              ><img loading="lazy" src="img/brand/pnup.png" width="100px" alt="brand"
            /></a>
          </div>
          <div class="brandarea__img">
            <a href="#"
      ...
      <div class="container">
          ...
          <div class="row">
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                  <div class="single__team">
                      <div class="teamarea__img">
                        <img loading="lazy"  src="img/mentor/mentor1.png" alt="team">
                      </div>
                      <div class="teamarea__content">
                          <h5><a href="#"> Lidemar Halide, S.T., M.T., CPSM
                          </a></h5>
                      </div>
                  </div>
              </div>
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                  <div class="single__team">
                      <div class="teamarea__img">
                        <img loading="lazy"  src="img/mentor/mentor2.png" alt="team">
                      </div>
                      <div class="teamarea__content">
                          <h5><a href="#">Muhammad Radiyal Musyaa, S.S.I., CPSM
                          </a></h5>
                      </div>
                  </div>
              </div>
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                  <div class="single__team">
                      <div class="teamarea__img">
                        <img loading="lazy"  src="img/mentor/mentor3.png" alt="team">
                      </div>
                      <div class="teamarea__content">
                          <h5><a href="#">Diantary Febrilia R, S.Pd., CPSM
                          </a></h5>
                      </div>
                  </div>
              </div>
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                <div class="single__team">
                    <div class="teamarea__img">
                        <img loading="lazy"  src="img/mentor/mentor4.png" alt="team">
                    </div>
                    <div class="teamarea__content">
                        <h5><a href="#">Budiman, S.Kom., CPSM
                        </a></h5>
                    </div>
                </div>
            </div>
        ...
        >
          <div class="about__right__wraper__2">
            <div class="educationarea__img" data-tilt>
              <img
                loading="lazy"
                class="aboutarea__2__img__1"
                src="img/about/about_2.png"
                alt="education"
              />
              <img
                loading="lazy"
                class="aboutarea__2__img__2"
                src="img/about/about_3.png"
                alt="education"
              />
              <img
                loading="lazy"
                class="aboutarea__2__img__3"
                src="img/about/about_4.png"
                alt="education"
              />
              <img
                loading="lazy"
                class="aboutarea__2__img__4"
        ...
        >
          <div class="aboutarea__content__wraper">
            <div class="aboutarea__button">
              <div class="default__small__button">Fitur Unggulan</div>
            </div>
            <div class="aboutarea__headding heading__underline">
              <h2>Latihan Bersama <span>AI</span></h2>
            </div>
            <div class="aboutarea__para aboutarea__para__2">
              <p style="text-align: justify;">
                Kehadiran fitur AI di platform kami bukan hanya sebuah terobosan inovatif 
                dalam dunia pelatihan online, tetapi juga kami harapkan menjadi solusi 
                efektif untuk menjawab berbagai tantangan dalam pengembangan keterampilan 
            ...
            <div class="aboutarea__list__2">
              <ul>
                <li>
                  <i class="icofont-check"></i> Mengatasi Kekurangan Umpan Balik Konstruktif
                </li>

                <li>
                  <i class="icofont-check"></i> Memudahkan Akses ke Pelatihan Berkualitas
                </li>

                <li>
                  <i class="icofont-check"></i> Menyediakan Alat Ukur Kemajuan yang Akurat
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="row">
        ...
        >
          <div class="counterarea__text__wraper">
            ...
            <div class="counter__content__wraper">
              <p style="font-weight: bold; font-size: 1.8em;">Kurikulum</p>
              <p style="margin-top: 10px;">Inovatif</p>
            </div>
          </div>
        </div>
        <div
        ...
        >
          <div class="counterarea__text__wraper">
            ...
            <div class="counter__content__wraper">
              <div class="counter__content__wraper">
                <p style="font-weight: bold; font-size: 1.8em;">100+</p>
                <p style="margin-top: 10px;">Peluang Belajar</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="counterarea__text__wraper">
            ...
            <div class="counter__content__wraper">
              <div class="counter__content__wraper">
                <p style="font-weight: bold; font-size: 1.8em;">3+</p>
                <p style="margin-top: 10px;">Mentor Ahli</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div class="counterarea__text__wraper">
            ...
            <div class="counter__content__wraper">
              <div class="counter__content__wraper">
                <p style="font-weight: bold; font-size: 1.8em;">Siap</p>
                <p style="margin-top: 10px;">Mendunia</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="populerarea__2 sp_top_50 sp_bottom_50">
    <div class="container">
      <div class="row">
        <div
          class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 about__wrap__content"
          data-aos="fade-up"
        >
          ...
          <div class="populerarea__content__wraper__2">
            <div class="section__title">
              ...
              <div class="section__title__heading">
                <h2>
                  Maximalkan Public Speaking Kamu dengan Fitur Unggulan Kami!
                </h2>
              </div>
            </div>

            <div class="populerarea__content__2">
              <p class="populerarea__para__1" style="text-align: justify;">
                Pilih paket kelas yang sesuai, manfaatkan review AI untuk umpan balik canggih, berlatih dengan uji tampil nyata, dan akses puluhan video pembelajaran kapan saja.
              </p>
              <p class="populerarea__para__2">
                Bergabunglah dengan kami dan transformasikan cara Anda berbicara di depan umum!
              </p>
            </div>
        ...
        <div
          class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 service__wrap__content"
        >
          ...
          <div class="row">
            ...
            >
              <div class="single__service">
                ...
                <div class="service__content service__content__2">
                  <h3>
                    <a href="event-details.html">Paket Kelas</a>
                  </h3>
                  <p>
                    Terdiri dari 2 jenis kelas, Kelas Dasar dan Kelas
                    Professional.
                  </p>
                </div>
              ...
              <div class="single__service">
                ...
                <div class="service__content service__content__2">
                  <h3>
                    <a href="zoom/zoom-meeting-details.html">Direview AI</a>
                  </h3>
                  <p>
                    Mendapatkan umpan balik secara real-time dari AI
                    untuk mengukur hasil presentasi.
                  </p>
                </div>
                <div class="service__button">
            ...
            >
              <div class="single__service ss_margin">
                ...
                <div class="service__content service__content__2">
                  <h3><a href="course-grid.html">Uji Tampil</a></h3>
                  <p>
                    Kamu dapat membuat pengalaman tampil sendiri
                    disaksikan oleh peserta Celoteh Yuk! lainnya.
                  </p>
                </div>
                <div class="service__button">
              ...
              <div class="single__service">
                ...
                <div class="service__content service__content__2">
                  <h3><a href="course-details-3.html">Video Pembelajaran</a></h3>
                  <p>
                    Kehadirannya mempermudah kamu tetap dapat mengakses
                    materi kapan saja dan mempelajari ulang materi.
                  </p>
                </div>
                <div class="service__button">
  ...
  <div class="pricingarea sp_bottom_100 sp_top_90" id="pricing">
    <div class="container">
      <div class="row" data-aos="fade-up">
        <div class="section__title text-center">
          <div class="section__title__button">
            <div class="default__small__button">Paket Harga</div>
          </div>
          <div class="section__title__heading">
            <h2>Biaya dan Benefit <br />Berlangganan</h2>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        >
          <div class="pricingarea__content__wraper">
            <div class="pricingarea__heading">
              ...
              <p>Sempurna untuk permulaan</p>
            </div>
            <div class="pricingarea__list">
              <ul>
                <li><i class="icofont-check"></i>1 pengguna</li>
                <li><i class="icofont-check"></i>1 Video Pembelajaran</li>
                <li>
                  <i class="icofont-close close__button"></i>Nikmati Fitur AI</li>
                <li>
                  <i class="icofont-close close__button"></i>Nikmati Fitur Uji Tampil
                </li>
                <li>
                  <i class="icofont-close close__button"></i>Kelas Pembelajaran
                </li>
              </ul>
            </div>
            <div class="pricingarea__button">
              <a class="default__button" href="#">Pilih Paket</a>
            </div>
          </div>
        </div>
          ...
          <div class="pricingarea__content__wraper">
            <div class="pricingarea__heading">
              ...
              <div class="pricingarea__number">
                <h1>
                  <span class="price__currency">Rp</span>129K<span
                    class="price__durition"
                    >/ 3 Bulan</span
                  >
                </h1>
              </div>
            ...
            <div class="pricingarea__list">
              <ul>
                <li><i class="icofont-check"></i>1 Pengguna</li>
                <li><i class="icofont-check"></i>Paket Kelas Dasar</li>
                <li><i class="icofont-check"></i>Akses Video Pembelajaran</li>
                <li><i class="icofont-check"></i> Nikmati Fitur AI</li>
                <li><i class="icofont-check"></i> Nikmati Fitur Uji Tampil</li>
                <li>
                  <i class="icofont-close close__button"></i> Terkhusus 1 Bidang
                </li>
              </ul>
            </div>
        ...
        >
          <div class="pricingarea__content__wraper">
            <div class="pricingarea__heading">
              ...
              <div class="pricingarea__number">
                <h1>
                  <span class="price__currency">Rp</span>229K<span
                    class="price__durition"
                    >/ 3 Bulan</span
                  >
                </h1>
              </div>
              <p>Sempurna Untuk Pengembangan</p>
            </div>
            <div class="pricingarea__list">
              <ul>
                <li><i class="icofont-check"></i>1 Pengguna</li>
                ...
                <li><i class="icofont-check"></i> Nikmati Fitur AI</li>
                <li><i class="icofont-check"></i> Nikmati Fitur Uji Tampil</li>
                <li><i class="icofont-check"></i> Terkhusus 1 Bidang</li>

              </ul>
            </div>
           @guest
            <div class="pricingarea__button">
              <a class="default__button" href="/login">Pilih Paket</a>
            </div>
           @endguest

           @auth
           <div class="pricingarea__button">
            <a class="default__button" href="https://celotehyuk.myr.id/pl/paket-basic-1-bulan-celoteh-yuk-98558">Pilih Paket</a>
          </div>
           @endauth
          </div>
        </div>
  ...
  <div class="aboutarea__3 testimonial__area__2 sp_bottom_90 sp_top_120">
    <div class="container">
      <div class="row">
        <div
          class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 custom__review__grid"
          data-aos="fade-up"
        >
          <div class="section__title aboutarea__3__section__title">
            <div class="section__title__button">
              <div class="default__small__button">Ulasan</div>
            </div>
            <div class="section__title__heading">
              <h2>Apa yang mereka katakan <br />Tentang kami?</h2>
            </div>
          </div>

          <div class="aboutarea__3__content">
            <p style="text-align: justify;">
              Temukan bagaimana pelanggan dan pengguna kami merasakan 
              pengalaman dengan layanan kami. Baca ulasan mereka untuk 
              melihat keberhasilan, kepuasan, dan bagaimana kami terus 
              berkomitmen untuk memberikan yang terbaik!
            </p>
          </div>
        </div>
        <div
          class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 custom__review__grid"
          data-aos="fade-up"
        >
    ...
    <div class="aboutarea__img__3">
      <img
        loading="lazy"
        class="aboutarea__3__img__1"
        src="img/about/about_6.png"
        alt="about"
      />
      <img
        loading="lazy"
        class="aboutarea__3__img__2"
        src="img/about/about_7.png"
        alt="about"
      />
      <img
        loading="lazy"
        class="aboutarea__3__img__3"
